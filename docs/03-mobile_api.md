...
| # | Method | Endpoint | Mô tả chức năng |
|---|---|---|---|
| 6.1 | POST | `/cameras/{cameraId}/devices/{key}/test` | Gửi lệnh test thiết bị còi/LED tại hiện trường (`sound_test_button`) |
...
**Tổng cộng: 47 API di động + 2 API tích hợp thiết bị (gồm 1 Webhook nhận diện và 1 WebSocket điều khiển; đã bỏ các chức năng ngôn ngữ, đổi mật khẩu, khôi phục mật khẩu, stream nghe thử âm thanh, và ghi đè trạng thái thiết bị thủ công).**
