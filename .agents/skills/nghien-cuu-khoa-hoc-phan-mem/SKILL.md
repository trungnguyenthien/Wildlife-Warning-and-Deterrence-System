...
Dùng đúng cấu trúc trong `references/cau-truc-chuan.md`. Đây là khung 10 phần bắt buộc
(trang bìa, tóm tắt, lời cảm ơn, mục lục, 5 phần nội dung chính, phụ lục).
...
- `references/cau-truc-chuan.md` — Chi tiết 10 phần của cấu trúc chuẩn, câu hỏi gợi ý nội dung
