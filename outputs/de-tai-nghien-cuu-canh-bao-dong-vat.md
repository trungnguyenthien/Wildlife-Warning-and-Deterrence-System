...
- [Tài liệu tham khảo](#10-tai-lieu-tham-khao)
- [Phụ lục](#11-phu-luc)
...
3. **Tab [DIEU_KHIEN] (Cấu hình hệ thống phòng vệ):**
   ...
   - **Nội dung:**
     - Các nút **Tự set hành vi nhanh** (Quick Presets): *Cảnh cáo nhẹ, Ngăn chặn trung bình, Khẩn cấp tối đa (tất cả tính năng)*.
...
- **Tính năng cảnh báo tại chỗ:** 
  - Khi có động vật hoang dã xâm nhập, màn hình xuất hiện **Banner cảnh báo nhấp nháy khẩn cấp**: *Tên Camera · Loài phát hiện · Thời gian phát hiện* (Ví dụ: `Cam 1 · Phát hiện VOI · 9:04`).
...
Màn hình này cho phép người dùng tùy biến và thiết lập trước kịch bản phòng vệ tự động cho từng loài động vật cụ thể. Khi mô hình AI phát hiện loài tương ứng, hệ thống sẽ kích hoạt các thiết lập phòng vệ đã được cấu hình tại đây.

- **Danh sách chọn loài động vật (Animal Selector Chips):** Hiển thị danh sách các loài có sẵn trong hệ thống: *Cá sấu, Nai, Voi, Hươu cao cổ, Báo, Khỉ, Tê giác, Rắn, Hổ*. Khi người dùng nhấn vào một loài để chọn, loài đó sẽ được làm nổi bật (Highlight).
- **Các nhóm cài đặt chi tiết (Defense Parameter Configurations):**
  - **Âm thanh xua đuổi:**
    - Lựa chọn loại âm thanh: *Tiếng súng, Tiếng gầm, Tiếng chó sủa lớn, Tiếng nổ giả lập, Tần số siêu âm*.
  ...
  - **Đèn LED nhấp nháy:**
    - Lựa chọn tần suất chớp: *2 lần/giây, 4 lần/giây, hoặc nhấp nháy ngẫu nhiên*.
    - Lựa chọn màu sắc LED: *Đỏ, Trắng, Đỏ xen kẽ Trắng*.
    - Cài đặt thời lượng nhấp nháy (Giây).
  - **Hàng rào điện:**
    - Lựa chọn mức độ dòng điện sinh học xua đuổi: *Thấp, Trung bình, hoặc Mạnh*.
  - **Gửi cảnh báo bằng loa:**
    - Lựa chọn giới tính giọng nói AI phát qua loa: *Nam hoặc Nữ*.
...
### 8.2. Kết quả thực nghiệm nhận diện và xua đuổi (Số liệu giả định phục vụ kiểm chứng)

Đề tài đã tiến hành thử nghiệm mô phỏng hệ thống với bộ dữ liệu gồm 500 video ghi hình động vật hoang dã ban đêm và ban ngày.

**Bảng 2: Kết quả nhận diện của mô hình AI**
| Loài động vật | Số lượng mẫu thử | Nhận diện đúng | Độ chính xác (%) | Thời gian xử lý trung bình (ms) |
|---|---|---|---|---|
| Voi | 150 | 142 | 94.6% | 120 ms |
| Cọp | 100 | 91 | 91.0% | 135 ms |
| Nai | 150 | 139 | 92.6% | 110 ms |
| Khỉ | 100 | 88 | 88.0% | 105 ms |

**Bảng 3: Thống kê hiệu quả xua đuổi theo từng phương pháp**
| Loài | Phương pháp áp dụng | Tỉ lệ xua đuổi thành công (%) | Hành vi ghi nhận |
|---|---|---|---|
| **Voi** | Loa phát thanh AI + Sóng âm tần số thấp | 92.5% | Quay đầu trở lại rừng sau 30-45 giây nghe loa |
| **Cọp** | Loa phát thanh AI + Đèn LED flash mạnh | 88.0% | Rút lui do bị chói mắt và giật mình bởi tiếng động lớn |
| **Nai** | Hàng rào điện sinh học (mức tê nhẹ) | 95.0% | Tránh xa khu vực rào chắn khi chạm nhẹ lần đầu |
| **Khỉ** | Âm thanh tần số thấp + Đèn LED flash | 85.0% | Di chuyển lên các tán cây cao và quay về rừng |
...
- Ứng dụng Android chạy ổn định ở hướng xoay dọc (Vertical Layout), hỗ trợ nhận thông báo đẩy nhanh chóng dưới **1.2 giây**.
...
[2] L. S. Wijeyasinghe, "Human-Elephant Conflict Mitigation Using Infrasound Technology: A Review," Journal of Wildlife Research, vol. 45, no. 3, pp. 201-215, 2022.
[3] Nguyễn Văn D, "Ứng dụng Trí tuệ Nhân tạo trong Giám sát Sinh cảnh và Bảo tồn Động vật Hoang dã tại Việt Nam," Tạp chí Khoa học Lâm nghiệp, số 4, tr. 45-56, 2023.
[4] FAO, "Guidelines for Human-Wildlife Conflict Management," Food and Agriculture Organization of the United Nations, Rome, Technical Paper No. 12, 2021.
```
...
### 11.1. Nhật ký nghiên cứu (Gantt Chart tiến độ dự án)
...
### 11.2. Mẫu tin nhắn SMS và kịch bản phát loa cảnh báo
