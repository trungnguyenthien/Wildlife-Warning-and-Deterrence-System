...
- **Danh sách chọn loài động vật (Animal Selector Chips):** Hiển thị danh sách các loài có sẵn trong hệ thống: _Cá sấu, Nai, Voi, Hươu cao cổ, Báo, Khỉ, Tê giác, Rắn, Hổ_. Khi người dùng nhấn vào một loài để chọn, loài đó sẽ được làm nổi bật (Highlight).
