...
*   **`role_dropdown` (Dropdown Menu hoặc [H1ChoiceButtonGroup](../UI_COMPONENTS.md#9-choicebuttongroups-bo-chon-lua-ngang-va-doc)):** Bộ chọn vai trò người dùng (Citizen / Ranger / Border Guard / Highway Admin) để gán quyền tương ứng (Bắt buộc).
